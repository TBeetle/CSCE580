...
def chat():
    f = open("/Users/tylerbeetle/Desktop/CSCE581/data/log.txt", "w")
    f.write("ChatBot: Hello and welcome to the recipe reccomender system!\nPlease give me some adjectives that describe your desired eating habits.\nType quit to exit.")
    ...
    while True: 
            ...
            if user_message.lower in ['quit','exit','goodbye', 'q']:
                ...
                break
            #feeds the users input into the responses list attempting to match keyword to a key in the list
            responses = chat_response(user_message)
            #returns the closest match to the user
            print("ChatBot: ", responses)
            f.write("ChatBot: "+ responses)
